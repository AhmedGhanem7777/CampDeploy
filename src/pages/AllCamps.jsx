...
//   "موريتانيا","المغرب","عُمان","فلسطين","قطر","السعودية","الصومال","السودان","سوريا","تونس",
...
//                 {/* الدولة (Dropdown RTL: النص يمين داخل الاختيار، والسهم أقصى الشمال) */}
...
//                       {/* اجعل النص يأخذ كامل المساحة ويُحاذى يمين */}
//                       <div className="flex-1 text-right truncate">
//                         <SelectValue placeholder="اختر الدولة" />
//                       </div>
//                       {/* السهم الذي يحقنه trigger سيكون على أقصى اليسار بسبب flex-row-reverse + justify-between */}
//                     </SelectTrigger>
