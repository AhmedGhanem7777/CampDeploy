...
//     { icon: Plane, label: "الخطط", path: "/dashboard/plans", allow: ["مسؤول"] },
//     { icon: Users, label: "طلبات الانضمام", path: "/dashboard/joinrequests", allow: ["مسؤول"] },

//     // صاحب مخيم فقط
//     { icon: Tent, label: "مخيماتي", path: "/dashboard/mycamps", allow: ["صاحب_مخيم"] },

//     // متاح للدورين
//     { icon: Calendar, label: "الحجوزات", path: "/dashboard/bookings", allow: ["صاحب_مخيم", "مسؤول"] },
...
export default function Sidebar() {
  ...
  const allItems: MenuItem[] = useMemo(() => ([
    ...
    { icon: Calendar, label: "تقييمات المالكين", path: "/dashboard/ownerReviews", allow: ["صاحب_مخيم"] },
    { icon: Calendar, label: "اداره العملاء", path: "/dashboard/adminCustomers", allow: ["مسؤول"] },
