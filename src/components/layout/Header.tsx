...
//   { title: 'جميع المخيمات', path: '/all-camps' },
...
//           <span className="font-bold text-lg">Camply</span>
//         </Link>
...
//         {/* Actions: Auth buttons in navbar + Settings (password only) + Mobile burger */}
...
//           {/* Settings: show only when authenticated, contains only Change Password */}
//           {isAuth && (
...
//                   className="w-full inline-flex items-center justify-center gap-2 rounded-lg px-3 py-2
//                              bg-destructive text-destructive-foreground hover:bg-destructive/90 transition-colors mt-2"
//                 >
//                   <LogOut className="w-4 h-4" /> تسجيل الخروج
//                 </button>
//               )}

//               {/* تذكير: تغيير الرقم السري يبقى ضمن أيقونة الإعدادات أعلى الهيدر عند تسجيل الدخول */}
